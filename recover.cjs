...
fs.writeFileSync(path.join('src', 'pages', 'student', 'LearningPage.tsx'), Buffer.from(learningPageCode, 'utf8'));
fs.writeFileSync(path.join('src', 'pages', 'student', 'StudentWorkbench.tsx'), Buffer.from(workbenchCode, 'utf8'));
