...
fs.writeFileSync(path.join('src', 'pages', 'student', 'LearningPage.tsx'), learningPageCode);
fs.writeFileSync(path.join('src', 'pages', 'student', 'StudentWorkbench.tsx'), workbenchCode);
