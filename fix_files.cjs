...
const StudentWorkbench = () => {
    ...
    return (
        <div className="flex h-screen w-full flex-col max-w-md mx-auto bg-background-light dark:bg-background-dark font-display text-slate-900 dark:text-white overflow-x-hidden relative">
            <div className="sticky top-0 z-50 flex items-center bg-background-light dark:bg-background-dark p-4 pb-2 justify-between border-b border-slate-200 dark:border-slate-800/50 backdrop-blur-md bg-opacity-90">
                ...
                <h2 className="text-slate-900 dark:text-white text-lg font-bold leading-tight tracking-tight flex-1 text-center pr-12">学生工作台</h2>
...
fs.writeFileSync('src/pages/student/LearningPage.tsx', learningPageCode);
fs.writeFileSync('src/pages/student/StudentWorkbench.tsx', workbenchCode);
